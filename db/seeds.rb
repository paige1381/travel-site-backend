...
Content.create([
  ...
  {
    text: 'These three things pretty much summed up my food experience in Nashville. Needless to say this was a positive experience, but before focusing on the delicious food we had, I have to call out the delicious beers that we had reallly quick.',
    image: 0,
    form_order: 1,
    blog_id: 1
  },
  ...
  {
    text: 'We grabbed drinks at pretty much every place we ate, including places like The Pharmacy, Tennessee Brewing Company, and Yazoo. All of which provided an amazing selection of beers, especially of the sour variety, but my ultimate favorite spot had to be The Southern Grist in east Nashville.',
    image: 0,
    form_order: 3,
    blog_id: 1
  },
  ...
  {
    text: 'Other spots for barbecue included Acme on Broadway, and Peg Leg Porker. Peg Leg Porker was hands down my favorite pulled pork sandwich ... and the Mac and cheeseeee. Oof. We stood in line during the lunch rush for about 30 minutes and it was totally worth it.',
    image: 0,
    form_order: 9,
    blog_id: 1
  },
  ...
  {
    text: '1) Altitude sickness is a real thing ... I’ll start out by mentioning that I had a cold coming into the week we were staying in Denver so I was already sick, but I completely forgot about the change in altitude and what that would additionally do to my body. Oops. On our first night here we stopped at a dispensary (because), then had an amazing dinner and drinks at Señor Bear.',
    image: 0,
    form_order: 1,
    blog_id: 2
  },
  ...
  {
    text: 'Later on we hit up Avanti for some drinks before meeting our awesome friends Grace and Drew at Osaka Ramen for dinner. We also hit up 10 Barrel Brewing Company (these guys have a great cucumber sour ... which sounds kind of funky but they made it work), and Sancho’s Broken Arrow, then called it a night. The next day we met up with Grace and Drew again, but in Golden where they live, and we took our respective pups for a short walk on the trails in William Frederick Hayden Park. The park was beautiful and I couldn’t believe how close it was located to their place. Apparently it’s great for mountain biking, but we also saw some horseback riders!',
    image: 0,
    form_order: 10,
    blog_id: 2
  },
  ...
  {
    text: 'After the hike we grabbed beers and tacos from Mountain Toad Brewing. What I’ve been slowly realizing about the West is that the people out here love their dogs more than they do on the east coast. JK. There are just way more dog-friendly places around here and this brewery was no exception. Remy was literally sitting with us at the table while we ate and drank.',
    image: 0,
    form_order: 12,
    blog_id: 2
  },
  ...
  {
    text: 'I will say that I was a little naive about just how bad and frequent the fires are in the area. Earlier in the week I had scoffed when I overheard a Denver resident complaining about how hot it was, thinking they don’t know the torture that is Virginia humidity, only to realize later that they weren’t complaining, just worrying about the threat of forest fires. Foot in mouth moment.',
    image: 0,
    form_order: 18,
    blog_id: 2
  },
  ...
  {
    text: 'After the hike it was horse time! Oh my god, it was so fun.',
    image: 0,
    form_order: 20,
    blog_id: 2
  },
  ...
  {
    text: 'I should mention that neither I nor Joey actually rode the horse by ourselves; Jamie was there holding onto the lead the whole time - thank god. But she did run with Tucker a bit which gave us the feeling of galloping through an open field on a horse. That was more than good enough for me. Joey and I couldn’t stop smiling the whole time haha.',
    image: 0,
    form_order: 22,
    blog_id: 2
  },
  ...
  {
    text: 'And then there was Saturday, our last full day in Colorado. Only slightly exhausted from the night before, we met back up with Jeff, Jamie, and Jeff’s son, also named Jeff, for a nice lunch in downtown Golden. That night we met up with some of Joey’s college friends and saw phab5 at Cervantes. Another really great show, especially with Todd Herrington repping RVA.',
    image: 0,
    form_order: 26,
    blog_id: 2
  },
  {
    text: 'And that was what I learned in Denver. Special shout out to Grace for her awesome recommendations and lodging, and Uncle Jeff and Jamie for being such sweet hosts. You guys made our time in Denver really special!',
    image: 0,
    form_order: 27,
    blog_id: 2
  },
  {
    text: 'I forgot one last thing I learned:',
    image: 0,
    form_order: 28,
    blog_id: 2
  },
  {
    text: '5) Stop staying in Ramada Inns ... they’re always sketchy regardless of location.',
    image: 0,
    form_order: 29,
    blog_id: 2
  },
  ...
  {
    text: "We made it back to the cabin that evening for another fire and dinner. We had to leave poor Remy inside though, and each time we'd turn around to face the house you'd just see her silhouette in the window staring so intently at us. We caved at one point and let her sit with us facing away from the fire because she kept creeping us out with her stare, and she started whining loudly.",
    image: 0,
    form_order: 22,
    blog_id: 4
  },
  ...
  {
    text: "It was a pretty short ride from Moab to Page, Arizona - 4.5 hours compared to the 7 and 8 hour trips we'd been making to get this far west. We made a point of taking the route that would swing us by Monument Valley, through the Navajo Reservation. I wasn't sure what to expect here, I had only seen instagram photos of those three iconic sandstone buttes and assumed those shots were taken from cars passing by. As we neared the area, there were a ton of turnouts, and I couldn't tell which rock formations were the three I'd seen a million times in photos. Based off of social media, you'd think that Monument Valley is home to only those buttes, but in reality they’re are everywhere.",
    image: 0,
    form_order: 1,
    blog_id: 5
  },
  ...
  {
    text: "Upper Antelope Canyon is seriously one of the most amazing experiences I've ever had. I'd love to visit again, but I'll definitely avoid the stress and grab a spot on a tour in advance.",
    image: 0,
    form_order: 11,
    blog_id: 5
  },
  ...
  {
    text: "Our first day in Page was pretty packed between the slot canyon tour and the UTV ride, so on our second day, which happened to be Cinco De Mayo, we decided to relax out on Lake Powell. Neither Joey nor I had really ever paddle boarded for any extended period of time, so we decided to rent some boards from Kayak Lake Powell and explore Antelope Canyon from the water.",
    image: 0,
    form_order: 1,
    blog_id: 6
  },
  ...
  {
    text: "We loaded up some beer and drove down to the boat ramp at Antelope Point Marina. This marina had one of the largest ramps I'd seen, which makes sense seeing as we saw multiple yachts out on the water during our stay. We had so much fun out on Lake Powell that day.",
    image: 0,
    form_order: 3,
    blog_id: 6
  },
  ...
  {
    text: "Floating through this area was like nothing I'd ever done before. On the east coast, at least in Virginia, any time I was paddling on a river or lake, trees and marsh were on either side of me. But on Lake Powell, you have these huge canyon walls that make you feel so small as you wind your way around them.",
    image: 0,
    form_order: 7,
    blog_id: 6
  },
  ...
  {
    text: "There were so many cool caves you could pull your board up under and just hang out in. Once we were further into the canyon, away from the wake of the larger, speedier boats, Joey made an attempt to stand up on his paddle board and he did really well ... for his first time haha.",
    image: 0,
    form_order: 9,
    blog_id: 6
  },
  ...
  {
    text: "I can't tell if she actually loved floating around on the water or if she really just wanted to be near us, most likely the latter.",
    image: 0,
    form_order: 16,
    blog_id: 6
  },
  ...
  {
    text: "When we started going farther out onto the lake with her, we decided to try out her new life vest. I don't think she was a huge fan of it; needless to say, it stayed on for probably 15 minutes.",
    image: 0,
    form_order: 18,
    blog_id: 6
  },
  ...
  {
    text: "I had a little photoshoot with Remy later on when she was super pooped:",
    image: 0,
    form_order: 20,
    blog_id: 6
  },
  ...
  {
    text: "And for those of you who liken her to a little seal, I had to post this one because of her leg placement haha:",
    image: 0,
    form_order: 23,
    blog_id: 6
  },
  ...
  {
    text: "We didn't stay super long in the viewing area because I swear it was the hottest, sunniest day in Page we'd experienced, and Remy was feeling it.",
    image: 0,
    form_order: 33,
    blog_id: 6
  },
  ...
  {
    text: "Regardless of the litter bugs at Horseshoe Bend though, Joey, Remy, and I absolutely loved the town of Page. Dare I say that it was our favorite stop on our road trip? Up next, Vegas baby!",
    image: 0,
    form_order: 35,
    blog_id: 6
  }
